...
class RPStyles {
  ...
  static final h2 = TextStyle(color: Colors.black, fontSize: 24, fontWeight: FontWeight.w500);
  static final h3 = TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w300);

  static final bodyText = TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.w400);
