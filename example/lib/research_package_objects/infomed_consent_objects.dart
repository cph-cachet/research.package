...
RPConsentSection dataGatheringSection = RPConsentSection.withParams(RPConsentSectionType.DataGathering)
  ..summary =
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut aliquet augue, sed maximus sapien. Cras non sem vulputate, tincidunt est in, euismod orci. Aenean elit nisl, convallis vel lacus eget, pellentesque laoreet nunc. Proin sed turpis odio. Aliquam quis metus eget tortor tristique posuere sed blandit velit. Vivamus velit magna, viverra ut commodo et, malesuada ut eros. Donec laoreet erat eget accumsan eleifend. Ut vel venenatis tortor. Maecenas sapien nisi, hendrerit eget velit eu, lobortis dictum massa. Pellentesque maximus et neque vel suscipit. Nunc eget massa sagittis, tincidunt turpis nec, suscipit est. Sed et vulputate massa. Suspendisse a magna sit amet nibh vehicula mattis. Fusce sed porta mauris, vel faucibus nunc. Etiam consectetur tortor eros, nec pretium risus molestie eu."
  ..content =
...
RPConsentSection privacySection = RPConsentSection.withParams(RPConsentSectionType.Privacy)
  ..summary =
      "This is a summary for Privacy. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut aliquet augue, sed maximus sapien. Cras non sem vulputate, tincidunt est in, euismod orci. Aenean elit nisl, convallis vel lacus eget, pellentesque laoreet nunc. Proin sed turpis odio. Aliquam quis metus eget tortor tristique posuere sed blandit velit. Vivamus velit magna, viverra ut commodo et, malesuada ut eros."
  ..content =
...
RPConsentSection aboutUs = RPConsentSection.withParams(RPConsentSectionType.AboutUs)
...
RPConsentSection passiveDataCollection =
    RPConsentSection.withParams(RPConsentSectionType.PassiveDataCollection)
      ..summary = "This study will ask you to provide the information about the following categories:"
      ..dataTypes = [
        RPDataTypeSection("Alcohol", "You have to input some info about alcohol in the alcohol card"),
        RPDataTypeSection("Mood", "You have to input some info about your mood in the mood card"),
        RPDataTypeSection("Weight", "You have to input some info about your weight in the weight card"),
        RPDataTypeSection(
            "Medications", "You have to input some info about your medications in the medications card"),
...
RPConsentDocument consentDocument = RPConsentDocument.withParams('Demo Consent', [
  overviewSection,
  aboutUs,
