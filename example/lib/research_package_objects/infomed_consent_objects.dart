...
RPConsentSection privacySection = RPConsentSection(type: RPConsentSectionType.Privacy, summary: "This is a summary for Privacy.",
  content:
...
RPConsentSection aboutUs = RPConsentSection(type: RPConsentSectionType.AboutUs, summary: "This is a summary for About Us.",
  content:
...
RPConsentSection customSection = RPConsentSection(
  ...
  content:
      "A Custom section dolor sit amet";
    );
...
RPConsentDocument consentDocumentAllSections = RPConsentDocument('Informed Consent', [
  overviewSection,
  aboutUs,
  dataGatheringSection,
  privacySection,
