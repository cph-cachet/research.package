...
RPOrderedTask get directNavigationExample {
// Answer options
...
// You will jump to this!
  RPInstructionStep instructionStepYouWillSee = RPInstructionStep(
      ...
      detailText: "Detail",
      text:
          "You jumped to me and didn't see the other steps - thats how the direct navigation step works");
  ...
  return directNavigationExample;
}
